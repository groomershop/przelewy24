            ...
            if (self::soap_method_exists($s, 'TransactionMotoCallBackRegister')) {
                ...
                $res = $s->__call('TransactionMotoCallBackRegister', array(
                    ...
                    'details' => array(
                        ...
                        'currency' => htmlspecialchars($order->getOrderCurrencyCode()),
                        ...
                        'client' => htmlspecialchars($order->getBillingAddress()->getData('firstname') . ' ' . $order->getBillingAddress()->getData('lastname')),
